                ...
                <div className="bg-gray-50 rounded-xl p-6 mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Base {property.price.type === 'rent' ? 'Rent' : 'Price'}:</span>
                      <span className="font-medium">₹{property.price.amount.toLocaleString('en-IN')}</span>
                    </div>
                    {property.price.brokerage && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">Brokerage:</span>
                        <span className="font-medium">₹{property.price.brokerage.toLocaleString('en-IN')}</span>
                      </div>
                    )}
                    {property.price.maintenance && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">Maintenance:</span>
                        <span className="font-medium">₹{property.price.maintenance.toLocaleString('en-IN')}</span>
                      </div>
                    )}
                    {property.price.gst && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">GST:</span>
                        <span className="font-medium">₹{property.price.gst.toLocaleString('en-IN')}</span>
                      </div>
                    )}
